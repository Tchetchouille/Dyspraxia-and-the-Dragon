...
# Indexes of the current fireball sprite for each color.
var y_index = 0
var o_index = 0
var r_index = 0
...
# When the fireball is created, we set its properties and apply an initial impulse.
func _ready() -> void:
#	Setting gravity to 0 for more pecise aiming
	gravity_scale = 0
